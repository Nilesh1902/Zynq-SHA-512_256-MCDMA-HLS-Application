...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { msg_strm_TVALID { I 1 bit } msg_strm_TDATA { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { msg_strm_TREADY { O 1 bit } msg_strm_TDEST { I 3 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { core_msg_strm_din { O 64 vector } core_msg_strm_full_n { I 1 bit } core_msg_strm_write { O 1 bit } core_msg_strm_num_data_valid { I 7 vector } core_msg_strm_fifo_cap { I 7 vector } } \
} "
}
