...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { blk_strm_din { O 1024 vector } blk_strm_full_n { I 1 bit } blk_strm_write { O 1 bit } blk_strm_num_data_valid { I 6 vector } blk_strm_fifo_cap { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { nblk_strm_din { O 128 vector } nblk_strm_full_n { I 1 bit } nblk_strm_write { O 1 bit } nblk_strm_num_data_valid { I 6 vector } nblk_strm_fifo_cap { I 6 vector } } \
} "
}
