...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { msg_strm_TVALID { I 1 bit } msg_strm_TREADY { O 1 bit } msg_strm_TDEST { I 3 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { core_len_strm_din { O 128 vector } core_len_strm_full_n { I 1 bit } core_len_strm_write { O 1 bit } core_len_strm_num_data_valid { I 3 vector } core_len_strm_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { core_end_len_strm_din { O 1 vector } core_end_len_strm_full_n { I 1 bit } core_end_len_strm_write { O 1 bit } core_end_len_strm_num_data_valid { I 3 vector } core_end_len_strm_fifo_cap { I 3 vector } } \
} "
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler test_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
