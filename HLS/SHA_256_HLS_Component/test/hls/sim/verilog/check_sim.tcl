...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.test.autotvin_msg_strm_V_data_V.dat"
         "c.test.autotvin_msg_strm_V_keep_V.dat"
         "c.test.autotvin_msg_strm_V_strb_V.dat"
         "c.test.autotvin_msg_strm_V_last_V.dat"
         "c.test.autotvin_msg_strm_V_dest_V.dat"
         "c.test.autotvin_msg_len.dat"
         "c.test.autotvin_dest_id.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.test.autotvout_digest_strm_V_data_V.dat"
         "rtl.test.autotvout_digest_strm_V_keep_V.dat"
         "rtl.test.autotvout_digest_strm_V_strb_V.dat"
         "rtl.test.autotvout_digest_strm_V_last_V.dat"
         "rtl.test.autotvout_digest_strm_V_dest_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
